import { MapPin, MessageSquare, Clock, Send } from 'lucide-react';
  ...
  return (
    <div className="bg-[#fafafa]">
      ...
      <section className="relative pt-32 pb-48 overflow-hidden bg-[#135c4e]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#135c4e] via-[#135c4e]/80 to-transparent"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            <span className="inline-block py-1 px-3 rounded-full bg-[#8c6b5d] text-white text-xs font-accent font-bold tracking-wider uppercase mb-6">
            ...
            <p className="text-lg text-white/80 mb-8">
              Estamos prontos para desenhar o seu melhor sorriso. Entre em contato para agendar sua avaliação ou tirar dúvidas sobre nossos tratamentos.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-10">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-sm font-accent font-bold text-gray-900 mb-2">WhatsApp</h4>
                    <p className="text-[#135c4e] text-lg font-accent font-medium mb-1">(11) 99876-5432</p>
                    <p className="text-gray-400 text-xs">Resposta média em 15 minutos</p>
                  </div>
                </div>
              ...
              <div className="mt-12 bg-[#e8f0ed] rounded-2xl p-8 border border-[#135c4e]/10">
                ...
                <p className="text-gray-600 text-sm mb-4">Para parcerias e informações administrativas.</p>
                <a href="mailto:contato@lifeodontologia.com.br" className="text-[#135c4e] font-accent font-medium hover:underline">
                  contato@lifeodontologia.com.br
                </a>
              </div>
            </div>
                ...
                <form className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <select className="w-full bg-[#fafafa] border-transparent focus:bg-white focus:border-[#135c4e] focus:ring-0 rounded-md py-3 px-4 text-sm transition-colors text-gray-600">
      ...
      <section className="relative h-[500px] bg-gray-200 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&q=80&w=1920')] bg-cover bg-center opacity-50 grayscale"></div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4">
          <div className="bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-2xl text-center max-w-sm w-full">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Localizada no coração do Itaim Bibi, nossa clínica oferece fácil acesso e estacionamento no local.
            </p>
            <button className="w-full bg-[#135c4e] text-white px-6 py-3 rounded-md font-accent font-medium hover:bg-[#0f4a3e] transition-colors flex items-center justify-center gap-2">
